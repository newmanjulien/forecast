import type { PreviewQuadrantChart, PreviewReport } from "./types";

export const previewExampleQuadrant: PreviewQuadrantChart = {
  id: "example-quadrant",
  title: "Drive revenue by comparing two forecasts",
  subtitle:
    "Overbase's data scientists do an in-depth audit which gives you a second forecast. You can drive easy revenue by comparing our forecast to your current forecast",
